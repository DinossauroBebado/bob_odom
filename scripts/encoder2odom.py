...
# Parameters
wheeltrack = 0.143  # distance between whells
wheelradius = 0.0325  # radius of the wheel in meters
TPR = 351  # ticks per turn
left_ticks = 0
right_ticks = 0
last_left_ticks = 0
last_right_ticks = 0
...
left_ticks_sub = rospy.Subscriber(
    "/bob/raw/left_ticks", Float32, leftTicksCallback)
right_ticks_sub = rospy.Subscriber(
    "/bob/raw/right_ticks", Float32, rightTicksCallback)
heading_sub = rospy.Subscriber("bob/heading", Float32, headingCB)
